        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mb-10 inline-flex flex-col items-start gap-3 rounded-2xl border border-border bg-background-secondary px-8 py-6 text-left">
              {[
                "This is how we think about the problems we solve",
                "Every piece represents real insight from real work",
                "Clear thinking is the foundation of everything we build",
              ].map((item) => (
            ...
            <p className="mb-3 text-lg leading-relaxed text-foreground">
              Ideas are how we start, but execution is how we finish.
            </p>
            <p className="mb-10 text-base leading-relaxed text-muted-foreground">
              If something you read here resonates with a challenge you&apos;re
              facing, let&apos;s talk about it.
            </p>
