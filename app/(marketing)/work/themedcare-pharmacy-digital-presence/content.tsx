...
import { ArrowRight, ChevronRight, ShieldPlus, Accessibility, Activity, Component } from "lucide-react";
...
export default function ThemedcareClientContent() {
  return (
    <main className="min-h-screen bg-white text-slate-900 selection:bg-blue-500/10">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/images/themedcare/hero.png" 
            alt="Themedcare Pharmacy Trust Abstract" 
            fill 
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={fadeIn} className="mb-8 flex items-center justify-center space-x-2 text-sm font-medium text-slate-500">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-slate-900">themedcare.ca</span>
            </motion.div>

            <motion.div variants={fadeIn} className="mb-6 inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-sm font-medium text-blue-700 backdrop-blur-sm">
              <ShieldPlus className="mr-2 h-4 w-4" />
              Case Study — Healthcare Trust & Clarity
            </motion.div>
            <motion.h1 variants={fadeIn} className="mb-6 text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl md:text-6xl lg:text-7xl">
              Establishing Trust for a Pharmacy&apos;s <br className="hidden md:block" />
            ...
            <motion.p variants={fadeIn} className="mx-auto max-w-2xl text-lg leading-relaxed text-slate-600 sm:text-xl">
              themedcare.ca is a physical pharmacy that transitioned to a strong digital presence. The work focused entirely on credibility, accessibility, and clear information architecture to serve patients better.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="mb-24 grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              <motion.div variants={fadeIn}>
                ...
                <p className="text-lg leading-relaxed text-slate-600">
                  themedcare.ca is an established physical pharmacy in Canada transitioning to
                  a stronger digital presence. Their original online identity
                  lacked vital trust, clarity, and compliance cues required in the healthcare industry.
                </p>
              </motion.div>
              
              <motion.div variants={fadeIn}>
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-white border border-slate-200 text-violet-600 shadow-sm">
                  <Accessibility className="h-6 w-6" />
                </div>
                <h2 className="mb-4 text-3xl font-bold text-slate-900">The Real Problem</h2>
                <p className="text-lg leading-relaxed text-slate-600">
                  The primary gap was a profound lack of credibility and discoverability, not e-commerce features. The digital presence did not visually convey trust or legal compliance, and vital patient information wasn't structured clearly enough to support confidence in care.
                </p>
              </motion.div>
            </motion.div>
            ...
            >
              <Image 
                ...
                alt="Accessible Healthcare Architecture" 
                fill 
          ...
          <div className="mb-24 grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              <motion.div variants={fadeIn}>
                ...
                <p className="text-lg leading-relaxed text-slate-600">
                  In healthcare, trust signals and rigorous accessibility aren't just features—they are the product. A credible digital presence demands clear, compliant information architecture and absolute reliability over flashy visual updates.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeIn}>
                ...
                <p className="text-lg leading-relaxed text-slate-600">
                  We prioritized a trust-centered information architecture and accessibility-first design decisions. This resulted in a rock-solid, reliable structure that naturally highlights clarity and vital compliance cues for anxious patients.
                </p>
              </motion.div>
            </motion.div>
          </div>
          ...
          >
            <motion.div variants={fadeIn} className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 transition-shadow hover:shadow-lg hover:shadow-slate-200/50">
              ...
              <p className="relative z-10 text-slate-600 leading-relaxed text-lg">
                A highly secure, accessible digital identity was deployed, drastically strengthening patient trust. The improved architecture enabled better patient feedback loops and reduced confusion regarding services and medication availability.
              </p>
            </motion.div>
            <motion.div variants={fadeIn} className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 transition-shadow hover:shadow-lg hover:shadow-slate-200/50">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 to-violet-50 opacity-0 transition-opacity group-hover:opacity-100" />
              <h3 className="relative z-10 mb-4 text-2xl font-bold text-slate-900">Reflection</h3>
              <p className="relative z-10 text-slate-600 leading-relaxed text-lg">
                When building for healthcare, aesthetics must serve utility. Flashy design that sacrifices WCAG accessibility or obscures critical health information actively harms the business and the patient. Trust is built through structural clarity.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="mb-10 text-lg text-slate-600 sm:text-xl">
              If your digital presence is lacking credibility or failing accessibility compliance, we can rebuild it on a foundation of trust.
            </p>
            <Link 
              href="/contact" 
